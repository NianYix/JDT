...
class DebugSession(Base):
    ...
    code_review_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("code_reviews.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
    code_generation_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("code_generations.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
